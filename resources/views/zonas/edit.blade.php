...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold mb-6">Editar Zona</h2>

    <form action="{{ route('zonas.update', $zona) }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        @method('PUT')

        <div class="mb-4">
            <label for="nombre" class="block text-gray-700 font-medium mb-2">Nombre *</label>
            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $zona->nombre) }}" 
        ...
        <div class="mb-4">
            ...
            <input type="text" name="ciudad" id="ciudad" value="{{ old('ciudad', $zona->ciudad) }}"
        ...
        <div class="mb-6">
            ...
            <textarea name="descripcion" id="descripcion" rows="3"
                class="w-full px-3 py-2 border rounded-lg">{{ old('descripcion', $zona->descripcion) }}</textarea>
        </div>
