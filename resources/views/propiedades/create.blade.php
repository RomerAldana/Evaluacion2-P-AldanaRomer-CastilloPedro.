...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold mb-6">Registrar Nueva Propiedad</h2>

    <form action="{{ route('propiedades.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
                <label for="precio_alquiler" class="block text-gray-700 font-medium mb-2">Precio Alquiler en $ *</label>
                <input type="number" step="0.01" name="precio_alquiler" id="precio_alquiler" value="{{ old('precio_alquiler') }}"
            ...
            <div>
                ...
                <input type="number" name="habitaciones" id="habitaciones" value="{{ old('habitaciones') }}" min="1"
        ...
        <div class="mb-4">
            <label class="flex items-center">
                <input type="checkbox" name="disponible" value="1" {{ old('disponible') ? 'checked' : '' }}
